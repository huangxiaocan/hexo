...
OpenJDK源代码不完整  
### 初识JDK11和JDK12的新特性
![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_1.png)  
JDK11重要的新特性    
![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_2.png) 
JDK11不重要的新特性
![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_3.png) 
JDK12重要的新特性
![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_4.png) 
JDK12不重要的新特性
![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_5.png) 
## 多版本JDK的安装和配置
### 安装JDK11和JDK12_264
下载安装文件：
...
![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_6.png)    
...
![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_7.png)  
新建系统变量CLASSPATH，添加如下配置

	.;%JAVA_HOME%\lib\dt.jar;%JAVA_HOME%\lib\tools.jar;

![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_8.png)   
编辑Path，添加如下配置

	%JAVA_HOME%\bin;%JAVA_HOME%\jre\bin;

![avatar](http://hc-image-upyun.test.upcdn.net/hexo/OpenJDK_1_9.png)    
