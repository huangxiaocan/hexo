...
### ip映射关系:（每个节点）如需使用用户名在web端访问需要在本地hosts文件添加如下对应操作
...
### 开始配置
#### 安装Java环境变量rpm包安装（rpm解压为全局变量，如下载其他java请配置环境变量）

	rpm  -ivh  安装包名称 

## 安装Mysql 卸载Linux系统上自带的mysql插件
### 查找mysql相关安装：
...
### 安装 Cloudera Manager 
	...
	无聊参考安装路径https://www.cnblogs.com/irich/p/6883839.html
